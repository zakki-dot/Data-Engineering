...
#confirm and set 'key' as index only if needed
...
# join census_df with cases_df
join_df = census_df.join(cases_df[['Cases']], how='inner')

#ioin the result with deaths_df
...
# show number of rows in final joined DataFrame
print("\nNumber of rows in join_df:")
print(len(join_df))

# sSelect only numeric columns from join_df
